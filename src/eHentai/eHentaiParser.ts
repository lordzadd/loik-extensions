...
const createTagSectionForNamespace = (namespace: string, tags: string[]): TagSection => { return createTagSection({ id: namespace, label: namespace, tags: tags.filter(tag => tag.startsWith(`${namespace}:`)).map(tag => createTag({ id: tag, label: tag.substring(namespace.length + 1) })) }) }

export const parseTags = (tags: string[]): TagSection[] => {
    const tagSectionArr = []

    switch (tags.shift()) {
        case 'Doujinshi': tagSectionArr.push(createTagSection({ id: 'categories', label: 'categories', tags: [createTag({ id: 'category:2', label: 'Doujinshi' })] })); break
        case 'Manga': tagSectionArr.push(createTagSection({ id: 'categories', label: 'categories', tags: [createTag({ id: 'category:4', label: 'Manga' })] })); break
        case 'Artist CG': tagSectionArr.push(createTagSection({ id: 'categories', label: 'categories', tags: [createTag({ id: 'category:8', label: 'Artist CG' })] })); break
        case 'Game CG': tagSectionArr.push(createTagSection({ id: 'categories', label: 'categories', tags: [createTag({ id: 'category:16', label: 'Game CG' })] })); break
        case 'Non-H': tagSectionArr.push(createTagSection({ id: 'categories', label: 'categories', tags: [createTag({ id: 'category:256', label: 'Non-H' })] })); break
        case 'Image Set': tagSectionArr.push(createTagSection({ id: 'categories', label: 'categories', tags: [createTag({ id: 'category:32', label: 'Image Set' })] })); break
        case 'Western': tagSectionArr.push(createTagSection({ id: 'categories', label: 'categories', tags: [createTag({ id: 'category:512', label: 'Western' })] })); break
        case 'Cosplay': tagSectionArr.push(createTagSection({ id: 'categories', label: 'categories', tags: [createTag({ id: 'category:64', label: 'Cosplay' })] })); break
        case 'Asian Porn': tagSectionArr.push(createTagSection({ id: 'categories', label: 'categories', tags: [createTag({ id: 'category:128', label: 'Asian Porn' })] })); break
        case 'Misc': tagSectionArr.push(createTagSection({ id: 'categories', label: 'categories', tags: [createTag({ id: 'category:1', label: 'Misc' })] })); break
    }
